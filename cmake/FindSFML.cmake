...
if(SFML_STATIC_LIBRARIES)
    ...
    if(NOT ${FIND_SFML_WINDOW_COMPONENT} EQUAL -1)
        ...
        if(FIND_SFML_OS_LINUX OR FIND_SFML_OS_FREEBSD)
            ...
            find_sfml_dependency(XCURSOR_LIBRARY "Xcursor" Xcursor)
        endif()
        ...
        elseif(FIND_SFML_OS_LINUX)
            set(SFML_WINDOW_DEPENDENCIES ${SFML_WINDOW_DEPENDENCIES} "GL" ${X11_LIBRARY} ${XRANDR_LIBRARY} ${XCURSOR_LIBRARY} ${UDEV_LIBRARIES})
        elseif(FIND_SFML_OS_FREEBSD)
            set(SFML_WINDOW_DEPENDENCIES ${SFML_WINDOW_DEPENDENCIES} "GL" ${X11_LIBRARY} ${XRANDR_LIBRARY} ${XCURSOR_LIBRARY} "usbhid")
